...
struct thread
{
    ...
    struct file* executable;            /* Use to deny writes to executables. */
...
struct child_process* add_child_process (int pid);  /* Add child process */
void thread_release_locks(void);                    /* Thread release locks */
